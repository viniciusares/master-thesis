function [H2,G2]=n2montaH2G2sing6(CANTOS,ELGEO,GEO,D,v)
    ...
    for J = 1 : n_el % Percorre os elementos, H2G2
        ...
        if J==elemAntes || J==elemDepois
            if J==elemAntes % J eh Elem Antes do canto I
                [h2cs,g2cs]=n3_h2g2CantoSing(X1,X2,X3,D,v,1);
            elseif J==elemDepois % J eh Elem Depois do canto I
                [h2cs,g2cs]=n3_h2g2CantoSing(X1,X2,X3,D,v,2);
            end
            h2(1,2)=h2cs(1,2);h2(1,4)=h2cs(1,4);h2(1,6)=h2cs(1,6); % Mn
            g2(1,1)=g2cs(1,1);g2(1,3)=g2cs(1,3);g2(1,5)=g2cs(1,5); % wc
        end
